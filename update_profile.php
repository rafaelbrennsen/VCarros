...
if(isset($_POST['submit'])){
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         $message[] = 'Senhas antigas não combinam.';
...
<section class="form-container update-form">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="Insira sua senha anterior." class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" placeholder="Insira sua senha atual." class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">

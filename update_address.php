...
if(isset($_POST['submit'])){
   if(isset($_POST['flat'], $_POST['building'], $_POST['area'], $_POST['town'], $_POST['city'], $_POST['state'], $_POST['country'], $_POST['pin_code'])){
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Seu endereço</h3>
      <input type="text" class="box" placeholder="Complementos" required maxlength="50" name="flat">
